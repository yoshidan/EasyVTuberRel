...
using App.Main.Scripts.MotionControl;
using UniRx;
using UnityEngine;
using Zenject;
...
namespace App.Main.Scripts.HumanInterfaceDevices
{
    public class KeyboardProvider : MonoBehaviour
    {
        ...
        private readonly static string[][] keyCodeNames = new string[][]
        {
            new string[]
            {
                "LControlKey", "LWin", "Alt", "_", "_", "_", "Space", "_", "_", "_", "_", "_", "_", "_", "RControlKey",
                "Left", "Down", "Right", "NumPad0", "_", "Decimal", "_",
            },
            new string[]
            {
                "LShiftKey", "_", "Z", "X", "C", "V", "B", "N", "M", "Oemcomma", "OemPeriod", "OemQuestion",
                "OemBackslash", "_", "RShiftKey", "_", "Up", "_", "NumPad1", "NumPad2", "NumPad3", "_"
            },
            new string[]
            {
                "CapsLock", "_", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Oemplus", "OemSemicolon",
                "OemCloseBrackets", "Enter", "_", "_", "_", "NumPad4", "NumPad5", "NumPad6", "_"
            },
            new string[]
            {
                "Tab", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Oemtilde", "OemOpenBrackets", "_", "_",
                "Delete", "End", "PageDown", "NumPad7", "NumPad8", "NumPad9", "Add",
            },
            new string[]
            {
                "_", "D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D0", "OemMinus", "OemQuotes", "OemPipe",
                "Back", "Insert", "Home", "PageUp", "NumLock", "Divide", "Multiply", "Subtract",
            },
            new string[]
            {
                "Escape", "_", "_", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12",
        ...
        [SerializeField] float[] radius = new float[]
        {
            0.2f,
            0.26f,
            0.32f,
        ...
        [SerializeField] float[] angleOffset = new float[]
        {
            0.0f,
            2.5f,
            0.0f,
        ...
        [SerializeField] float[] anglePerItem = new float[]
        {
            5.0f,
            5.0f,
            4.0f,
        ...
        private static int GetFingerNumberOfKey(string key)
        {
            ...
            return fingerMapper.ContainsKey(sanitized) ? fingerMapper[sanitized] : FingerConsts.LeftLittle;
        }
