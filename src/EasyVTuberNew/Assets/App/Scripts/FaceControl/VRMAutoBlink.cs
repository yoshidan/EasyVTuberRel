...
namespace App.Main.Scripts.FaceControl
{
    ...
    public class VRMAutoBlink : MonoBehaviour
    {
        ...
        public float _currentBlinkValue = 0f;
        ...
        {
            //TODO 蓄積されたままクリアされず溜まっていってしまうので 絶対値指定（重複すると死ぬ）
            proxy.ImmediatelySetValue(BlinkLKey, _currentBlinkValue);
            proxy.ImmediatelySetValue(BlinkRKey, _currentBlinkValue);
